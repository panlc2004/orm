...
<mapper namespace="${mapperClassName}">
    ...
    <select id="selectListRelativeByParams" resultMap="BaseResultMap" parameterType="com.czy.core.orm.base.QueryParams">
        select
        <if test="@com.czy.core.orm.sql.util.MybatisColumnsOGNL@hasSelectColumns(_parameter)">
            <foreach collection="_parameter.selectColumns" item="selectColumn" separator=",">${name}.${r'${selectColumn}'}</foreach>
        </if>
    ...
    <select id="selectOneRelativeByParams" resultMap="BaseResultMap" parameterType="com.czy.core.orm.base.QueryParams">
        select distinct
        <if test="@com.czy.core.orm.sql.util.MybatisColumnsOGNL@hasSelectColumns(_parameter)">
            <foreach collection="_parameter.selectColumns" item="selectColumn" separator=",">${name}.${r'${selectColumn}'}</foreach>
        </if>
